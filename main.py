...
almosteverything = mapinteraction.add_to_almosteverything([ostblock.wallcreation(), Gambling.roulette_trigger_zone, Characters.npc, Slots.slot_trigger_zone], mapinteraction.almosteverything)
